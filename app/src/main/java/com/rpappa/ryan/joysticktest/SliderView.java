...
public class SliderView extends View implements Runnable {
    // Constants
    ...
    public SliderView(Context context, AttributeSet attrs, int defaultStyle) {
...
//        System.out.println("measured width: " + MeasureSpec.getSize(widthMeasureSpec));
//        System.out.println("measured height: " + MeasureSpec.getSize(heightMeasureSpec));
//
        int width;
        int height;
...
//        int widthSize = MeasureSpec.getSize(widthMeasureSpec);
        ...
        width = (int) (((height / 2 * 0.25)-(d / 2 * 0.25)/5)*2);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect((float)centerX-buttonRadius-buttonRadius/5, 0, (float)centerX+buttonRadius+buttonRadius/5, (float)joystickRadius*3, mainCircle);

        // painting the main circle
//        canvas.drawCircle((int) centerX, (int) centerY, joystickRadius,
//                mainCircle);
        // painting the secondary circle
        canvas.drawCircle((int) centerX, (int) centerY, buttonRadius+buttonRadius/5,
                secondaryCircle);

        // paint lines
        canvas.drawLine((float) centerX, (float) centerY, (float) centerX,
                (float) (centerY - joystickRadius), verticalLine);
        canvas.drawLine((float) (centerX -buttonRadius-buttonRadius/5), (float) centerY,
                (float) (centerX+buttonRadius+buttonRadius/5), (float) centerY,
                horizontalLine);
...
//        if(yPosition>centerY) {
//        System.out.println(yPosition-centerY);
